...
public class ViewReservationCalendar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // time picker dialog
                picker = new TimePickerDialog(ViewReservationCalendar.this,
        ...
        startDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                dpicker = new DatePickerDialog(ViewReservationCalendar.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View v) {
                ...
                if (!(start_date.isEmpty() | end_date.isEmpty() | start_time.isEmpty() | end_time.isEmpty())) {
                    ...
                    if(getDaysBetweenDates(dateFrom, dateTo)>0)
                    {
                        try {
                            if (validateTime() > 0) {
                                ViewReservations( dateFrom, dateTo);
                            }
                            else
                            {
    ...
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR1)
    private void ViewReservations( String startDate, String endDate) {
        //clearing whatever is in scroll list first
        scrollList.removeAllViewsInLayout();
        // search for cars
        allReservations = reservationDbOperations.ViewReservations( startDate, endDate);
        if(allReservations.size()<=0){
            Toast.makeText(getApplicationContext(), "No Reservations", Toast.LENGTH_SHORT).show();
            return;
        }
        for (final ArrayList<String> car : allReservations) {
            final String carName = car.get(0);
            String occupantCapacity = car.get(1);
            String startdate = car.get(2);
            String enddate = car.get(3);
            String totalcost = car.get(4);
           final String reservationId = car.get(5);
            ...
            linearItem.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    navigationHelper.GotoReservationRM(reservationId);
                }
            });
